...
export interface MockUniswapDestinationInterface extends utils.Interface {
  functions: {
...
export interface MockUniswapDestination extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockUniswapDestinationInterface;
