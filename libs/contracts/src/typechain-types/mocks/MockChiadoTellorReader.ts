...
export interface MockChiadoTellorReaderInterface extends utils.Interface {
  functions: {
...
export interface MockChiadoTellorReader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockChiadoTellorReaderInterface;
  ...
  functions: {
    ...
    getQueryId(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getQueryId(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getQueryId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
