...
export interface BenchUsingTellorInterface extends utils.Interface {
  functions: {
    ...
    "sliceUint(bytes)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "sliceUint", data: BytesLike): Result;
...
export interface BenchUsingTellor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BenchUsingTellorInterface;
