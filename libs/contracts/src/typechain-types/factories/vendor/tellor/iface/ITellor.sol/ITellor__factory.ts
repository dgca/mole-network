...
import type {
  ITellor,
  ITellorInterface,
} from "../../../../../vendor/tellor/iface/ITellor.sol/ITellor";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: "enum ITellor.VoteResult",
        name: "",
        type: "uint8",
      },
      {
  ...
  {
    inputs: [],
    name: "rescueBrokenDataReporting",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class ITellor__factory {
  static readonly abi = _abi;
  static createInterface(): ITellorInterface {
    return new utils.Interface(_abi) as ITellorInterface;
  }
  static connect(
    address: string,
